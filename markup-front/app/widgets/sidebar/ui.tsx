        ...
        {imageDirectoryHandle ? (
          <div className="p-3 bg-white dark:bg-[#424242] rounded-lg border border-[#e8e6e3] dark:border-[#484848]">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-[#4a4a4a] dark:text-gray-300 truncate">
                {backgroundImages.length} images
              </span>
            </div>
          </div>
        ) : (
